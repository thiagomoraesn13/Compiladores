...
public class Scanner {
	...
	static {
		...
		literals.put("Sobrenome", new Integer(3));
		literals.put("Pais", new Integer(5));
		literals.put("Filhos", new Integer(7));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 1:
					...
					if (ch == 39 || ch == '-' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 2:
					recEnd = pos; recKind = 2;
					if (ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 4:
					{t.kind = 6; break loop;}
				case 5:
					if (ch == 'f') {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
					if (ch == 'a') {AddCh(); state = 7; break;}
					else {state = 0; break;}
				case 7:
					if (ch == 'l') {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					if (ch == 'e') {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
					if (ch == 'c') {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
					if (ch == 'i') {AddCh(); state = 11; break;}
					else {state = 0; break;}
				case 11:
					if (ch == 'd') {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
